...
export class Hero {
    ...
    public countOn(team: Team | List<Team>) {
...
export class Heroes {
    ...
    public static resetAvalibleHeroesFor(player: Player | List<Player>) {
