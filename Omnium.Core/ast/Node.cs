...
namespace Omnium.Core.ast
{
    ...
    public static class NodeExtensions
    {
        ...
        {
            //Todo: Account for imported symbols
            ...
            return sourceFile == targetFile || sourceFile.ImportedSourceFiles.Select(x => x.TargetSourceFile).Contains(targetFile);
        }
    }
