        ...
        private void UpdateReferences(INode node)
        {
            ...
            switch (node)
            {
                ...
                case SourceFile sourceFile:
                    var oldSourceFiles = sourceFile.ImportedSourceFiles.ToList();
                    sourceFile.ImportedSourceFiles.Clear();
                    sourceFile.ImportedSourceFiles.AddRange(oldSourceFiles.Select(GetClone));
                    break;
